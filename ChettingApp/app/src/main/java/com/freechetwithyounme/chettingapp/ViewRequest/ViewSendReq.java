...
public class ViewSendReq extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toolbar toolbar = findViewById(R.id.toolbar_vewSendReq);
        ImageView back= findViewById(R.id.toolbar_back);
        TextView toolbarText= toolbar.findViewById(R.id.toolbar_text);
        toolbarText.setText("Request Friend's");
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(ViewSendReq.this, MainActivity.class));
            }
        });
    ...
    public void onStart() {
        ...
        FirebaseRecyclerOptions<User> options = new FirebaseRecyclerOptions.Builder<User>().setQuery(friendReqReference, User.class).build();

        final FirebaseRecyclerAdapter<User, UserSendFRViewHolder> adapter = new FirebaseRecyclerAdapter<User, UserSendFRViewHolder>(options) {
                    @Override
